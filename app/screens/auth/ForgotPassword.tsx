...
import { requestForgotPassword } from "../../services/auth/forgotPassword.service";
import {
...
export default function ForgotPassword({ navigation }: any) {
  ...
  const forgotPasswordMutation = useMutation({
    ...
    onError: (err: any) => {
      ...
      Alert.alert("Request Failed", err.message || "Could not process request");
    },
  });
      ...
      >
        ...
        <TouchableOpacity
          className={`bg-[#1C6206] h-[56px]  rounded-full justify-center items-center mt-auto mb-[30px] ${
            isSubmitting || forgotPasswordMutation.isPending ? "opacity-60" : ""
          }`}
